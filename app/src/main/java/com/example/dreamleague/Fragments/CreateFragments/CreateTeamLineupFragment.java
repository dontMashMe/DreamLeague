...
public class CreateTeamLineupFragment extends Fragment {
    ...
    //ostalo
    TextView lastRememberedPosition, txt_balance, txt_team_name;
    //player scorevi
    ...
    void setupViews(View v) {
        ...
        txt_team_name = v.findViewById(R.id.txt_create_teamname);
    ...
    void setupClickListeners() {
        ...
        btn_deleteAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                lastRememberedTeamSize = lineupSingleton.ReturnList().size();
                txt_balance.setText(String.format("Konto: %.2fM$", userBalance / 1000000.0));
    ...
    void unsetAll(DreamTeam dreamTeam){
        ...
        dreamTeam.setDefenderLeft(0);
        dreamTeam.setDefenderRight(0);
        dreamTeam.setDefenderMidFirst(0);
        dreamTeam.setDefenderMidSecond(0);
        dreamTeam.setMidLeft(0);
        dreamTeam.setMidMidFirst(0);
        dreamTeam.setMidMidSecond(0);
        dreamTeam.setMidRight(0);
        dreamTeam.setAttackLeft(0);
        dreamTeam.setAttackRight(0);
    }
